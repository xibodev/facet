	...
	methods := []Method{
		...
		method("explainer", "Explainer", "Text-, metric-, and supplied-media-led explanation.", "explainer",
			route("local-explainer", "Local Remotion explainer", "Compose an approved script with optional supplied visuals using the local renderer.",
				...
				artifact("video_compose", "output", "render_video", "output_review", "input")),
			route("edge-narrated-explainer", "Edge-narrated Remotion explainer", "Use a natural keyless network voice when online text processing is acceptable, then compose locally.",
				inputs("script"), "edge_tts", []string{"edge_tts", "video_compose", "output_review"},
				inputBinding("script", "edge_tts", "text"),
				inputTextSequence("script", "video_compose", "cuts"),
				artifact("edge_tts", "output_path", "narration", "video_compose", "audio.narration.src"),
				artifact("video_compose", "output", "render_video", "output_review", "input")),
			route("piper-narrated-explainer", "Offline Piper-narrated Remotion explainer", "Use the installed local voice when privacy or offline operation matters, then compose locally.",
				inputs("script"), "piper_tts", []string{"piper_tts", "video_compose", "output_review"},
				inputBinding("script", "piper_tts", "text"),
				inputTextSequence("script", "video_compose", "cuts"),
				artifact("piper_tts", "output_path", "narration", "video_compose", "audio.narration.src"),
				artifact("video_compose", "output", "render_video", "output_review", "input")),
