...
- Inspect the actual video and audio. Process success is not creative
  acceptance.
- Keep human approval separate from technical review and never grant it on a
  person's behalf.
- Preserve useful requests, assets, renders, and review reports as ordinary
  project files; do not invent mandatory workflow state.
- Disclose failures, substitutions, rights or consent concerns, and anything
